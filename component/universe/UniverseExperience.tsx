...
export default function UniverseExperience({
  ...
  const openCollectionItem = (
    ...
    /*
     * Stop background music while
     * Little Collection music is open.
     */
    if (
      item === "music" &&
  ...
  const closeCollectionItem = () => {
    ...
    /*
     * Resume background music after
     * closing collection modal.
     */
    const background =
      backgroundAudioRef.current;
  ...
  const passwordScreen =
    ...
    typeof universe.password_screen ===
      "object" &&
    !Array.isArray(
      universe.password_screen
    )
  ...
  function changeScene(
    nextStep: ExperienceStep
  ) {
    setIsSceneTransitioning(
      true
    );
  ...
  return (
    <main className="reference-universe">
                ...
                {memoryImages.map(
                  (
                    ...
                    <div
                      ...
                      className={`reference-memory-photo memory-photo-${
                        index + 1
                      }`}
                    >
                ...
                <div className="reference-letter-paper-body">
                  ...
                  <div className="reference-letter-text">
                    ...
                    {creatorLetter ? (
                      ...
                      <>
                        <p>
                          I wanted to leave you a little something here.
                        </p>

                        <p>
                          A tiny reminder of all the beautiful moments, little laughs, and memories that make this story special.
                        </p>

                        <p>
                          I hope whenever you come back to this little universe, it makes you smile. ♡
                        </p>
                      </>
                    )}
      ...
      {/* =========================================
          SURPRISES / LITTLE COLLECTION
      ========================================= */}

      {step === "surprises" && (
        <section className="reference-surprises-scene">

          <div className="reference-surprise-glow surprise-glow-one" />
          <div className="reference-surprise-glow surprise-glow-two" />

          <div className="reference-surprise-content">

            <span className="reference-surprise-chapter">
              THE LITTLE COLLECTION
            </span>

            <h1 className="reference-surprise-title">
              Pick a little
              <br />
              surprise ♡
            </h1>

            <p className="reference-surprise-intro">
              six tiny things,
              <br />
              made just for you
            </p>
            ...
            <div className="surprise-collection-grid">
              ...
              >
                <img
                  src="/surprise/icons/memories.svg"
                  alt="Memories"
                />
              ...
              >
                <img
                  src="/surprise/icons/flowers.svg"
                  alt="Flowers"
                />
              ...
              >
                <img
                  src="/surprise/icons/surprise.svg"
                  alt="Surprise"
                />
          ...
          <div className="reference-surprise-modal">
            ...
            {collectionModal ===
              ...
              <div className="reference-modal-content">
                ...
                {collectionMemoryImages.length >
                0 ? (
                  <div className="reference-memory-modal-grid">

                    {collectionMemoryImages.map(
                      (
                        image,
                        index
                      ) => (
